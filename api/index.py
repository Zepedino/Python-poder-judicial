...
def buscar_nombre():
    try:
        ...
        print(f"[INFO] Iniciando scraping para {tipo_persona}: {nombres} {apellido_paterno} {apellido_materno}" if tipo_persona == 'natural' else f"[INFO] Iniciando scraping para empresa: {nombre_persona_juridica}")
        ...
        print("[INFO] Scraping exitoso, iniciando traducción con Gemini...")
        ...
        print(f'[ERROR] Error en búsqueda por nombre: {e}')
        import traceback
        traceback.print_exc()
        return jsonify({
