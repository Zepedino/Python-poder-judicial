...
# Mapeo de Tribunales a sus códigos numéricosTRIBUNALES_MAP_CIVIL = {
TRIBUNALES_MAP_CIVIL = {
...
TRIBUNALES_MAP_COBRANZA = {
  ...
  'Jdo. de Letras del Trabajo de Copiapo': '136', # OJO: Tu constants.py tenía '136' para este en la sección Cobranza
